...
/*
		...
		*/
		...
		auto exportFile = OpenFile( "$saves:COMObjectEditorSaveChiemsee.json", FileMode.WRITE );

        if( !exportFile )
        {
            COM_Message( "Error writing COMObjectEditorSaveChiemsee.json. Current changes could not NOT be saved!!!" );
            return;
        }
		...
		COM_Message( "Saved objects to COMObjectEditorSaveChiemsee.json (User/Documents/DayZ)." );
//		JsonFileLoader< SceneSaveST >.JsonSaveFile( BASE_SCENE_DIR + "\\" + "latest.json", scene );
//		JsonFileLoader< SceneSaveST >.JsonSaveFile( "$saves:COMObjectEditorSaveChiemsee.json", scene );
	}
...
//		JsonFileLoader<SceneSaveST>.JsonLoadFile( BASE_SCENE_DIR + "\\" + "latest.json", scene );
		JsonFileLoader<SceneSaveST>.JsonLoadFile( "$saves:COMObjectEditorSaveChiemsee.json", scene );
