class COMCharacterMenu extends UIScriptedMenu
{
	...
	override Widget Init()
	{
		...
		layoutRoot = GetGame().GetWorkspace().CreateWidgets( "$CurrentDir:missions\\DayZCommunityOfflineMode.Chiemsee\\core\\modules\\Persistency\\gui\\layouts\\COMCharacterMenu.layout" );
