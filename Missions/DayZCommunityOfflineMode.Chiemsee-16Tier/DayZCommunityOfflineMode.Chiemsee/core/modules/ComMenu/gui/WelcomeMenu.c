class WelcomeMenu extends UIScriptedMenu
{
    ...
    {
        layoutRoot = GetGame().GetWorkspace().CreateWidgets( "$CurrentDir:missions\\DayZCommunityOfflineMode.Chiemsee\\core\\modules\\ComMenu\\gui\\layouts\\WelcomeMenu.layout" );
